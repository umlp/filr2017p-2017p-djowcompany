...
Le logiciel est un outil pour faire gagner tu temps aux musiciens : il doit par conséquent être pris en main très rapidement. L'utilisateur doit être capable d'utiliser correctement 90% des fonctions en moins de 15min (suite à un tutoriel/visite guidée).
De plus, il doit être accessible à des enfants de moins de 8 ans, ainsi qu'aux musiciens totalement débutants.

L'ergonnomie du logiciel doit aussi être pensée pour satisfaire des utilisateurs occasionels, qui par exemplent essayent d'apprendre le solfège mais ont un doute sur une partition. 

Le produit étant un logiciel, il est important qu'il possède d'un bon feedback, afin que les musiciens pratiquent le bouche à oreille en faveur des ventes du produit.
